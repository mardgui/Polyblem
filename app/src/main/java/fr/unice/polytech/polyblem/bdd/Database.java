...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String ISSUE_CREATE_TABLE =
            "CREATE TABLE " + ISSUE_TABLE_NAME + " ( " + ISSUE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                    ...
                    ISSUE_CATEGORY + " TEXT CHECK (category IN ('Catégorie','Manque','Casse','Dysfonctionnement', 'Propreté', 'Autre')), " +
                    ISSUE_DESCRIPTION + " TEXT," +
                    ISSUE_LOCATION + " TEXT CHECK (location IN ('Lieu','Parking','Toilettes','Foyer','Bâtiment O','Bâtiment E', 'Autre'))," +
    ...
    public long addIssue(Issue issue) {
        ...
        values.put(ISSUE_CATEGORY, issue.getCategory().getName());
        values.put(ISSUE_DESCRIPTION, issue.getDescription());
        values.put(ISSUE_LOCATION, issue.getLocation().getName());
